        ...
        <td align="left" style="padding: 12px 0;">
          <a href="https://customerloop.in" target="_blank" style="text-decoration: none; display: inline-flex; align-items: center;">
            <div style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 24px; font-weight: 800; color: #10b981; letter-spacing: -0.5px;">
              Customer<span style="color: #38bdf8;">Loop</span>
              <span style="background: linear-gradient(135deg, #10b981 0%, #06b6d4 100%); -webkit-background-clip: text; color: #10b981; font-size: 11px; font-weight: 700; text-transform: uppercase; margin-left: 8px; padding: 2px 8px; border: 1px solid rgba(16, 185, 129, 0.3); border-radius: 9999px;">AI PLATFORM</span>
            </div>
          </a>
        </td>
      </tr>
