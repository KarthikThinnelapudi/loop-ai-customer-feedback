...
import { BarChart3, TrendingUp, Layers, Download, Upload } from "lucide-react";
...
export default function AnalyticsPage() {
  ...
  const handleExportAnalyticsCsv = () => {
    const csvLines = [
      ...
      ...defaultCategoryPieData.map((c) => [c.name, `${c.value}%`]),
      [],
      ["Channel", "Feedback Count", "Sentiment Score"],
      ...defaultChannelBreakdown.map((b) => [b.channel, b.count, b.sentiment]),
    ];
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800/80 pb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-semibold text-xs transition border border-slate-700 disabled:opacity-50"
          >
      ...
      {isWorkspaceEmpty ? (
        <Card className="p-12 text-center my-6">
          <EmptyState
            ...
            description="Import or add customer feedback to visualize sentiment evolution ratios, channel breakdowns, and feature area shares."
            actionLabel="Import Feedback CSV"
          ...
          <Card className="space-y-4 mt-6">
            ...
            <div className="h-80 w-full pt-4">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={defaultSentimentTrend}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
            ...
            <Card className="space-y-4">
              ...
              <div className="h-64 w-full pt-2">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={defaultChannelBreakdown}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#1e293b" />
            ...
            <Card className="space-y-4">
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
                      ...
                      dataKey="value"
                    >
                      {defaultCategoryPieData.map((entry, index) => (
              ...
              <div className="flex flex-wrap justify-center gap-4 text-xs pt-2 border-t border-slate-800">
                {defaultCategoryPieData.map((item) => (
